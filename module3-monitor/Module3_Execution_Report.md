...
![Module 3 運用自動化＆監視アーキテクチャ](../docs/images/M3_Architecture_ver2.png)
...
- **担当別への通知構造**: 条件分岐（Condition）をネスト構造で実装し、CPU負荷、応答遅延、可用性停止の3つの障害ごとに件名と本文を書き分け、別々のメールアドレスへ自動ルーティングする配信網を確立。
